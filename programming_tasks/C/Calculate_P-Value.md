[1]: http://rosettacode.org/wiki/Calculate_P-Value

# [Calculate P-Value][1]

Perhaps "inspired by C example" may be more accurate. Gamma subroutine from [Gamma function task](http://rosettacode.org/wiki/Gamma_function#Perl_6).
