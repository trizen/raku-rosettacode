[1]: http://rosettacode.org/wiki/Deconvolution/1D

# [Deconvolution/1D][1]

Translation of Python, using a modified version of the Reduced Row Echelon Form subroutine `rref()` from [here](/wiki/Reduced\_row\_echelon\_form#Perl\_6" title="Reduced row echelon form).
