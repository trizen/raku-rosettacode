...
Translation of Python, using a modified version of the subroutine `rref` from [ Reduced row echelon form](https://rosettacode.org/wiki/Reduced_row_echelon_form#Raku) task.
