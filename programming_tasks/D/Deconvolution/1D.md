...
Translation of Python, using a modified version of the Reduced Row Echelon Form subroutine `rref()` from [here](http://rosettacode.org/wiki/Reduced_row_echelon_form#Perl_6).
