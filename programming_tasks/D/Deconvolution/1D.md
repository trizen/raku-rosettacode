...
Translation of Python, using a modified version of the Reduced Row Echelon Form subroutine `rref()` from [here](https://rosettacode.org/wiki/Reduced_row_echelon_form#Raku).
