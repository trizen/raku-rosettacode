...
Variant of a Mandelbrot script from the [Perl 6 ecosystem](http://modules.perl6.org/). Produces a [Portable Pixel Map](https://rosettacode.org/wiki/Write_ppm_file) to STDOUT.
