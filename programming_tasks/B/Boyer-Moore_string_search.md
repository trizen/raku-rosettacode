[1]: https://rosettacode.org/wiki/Boyer-Moore_string_search
...
Output is the same as the [Knuth-Morris-Pratt_string_search#Raku](https://rosettacode.org/wiki/Knuth-Morris-Pratt_string_search#Raku) entry.
