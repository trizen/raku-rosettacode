[1]: http://rosettacode.org/wiki/Nautical_bell

# [Nautical bell][1]

Perl 6 uses [UTC](http://en.wikipedia.org/wiki/Coordinated\_Universal\_Time" class="extiw" title="wp:Coordinated Universal Time) (GMT) time internally and by default. This will display the current UTC time and on the half hour, display a graphical representation of the bell. If run in a terminal with the system bell enabled, will also chime the system alarm bell.
